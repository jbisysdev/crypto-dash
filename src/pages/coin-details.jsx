...
import { FaArrowLeftLong, FaGlobe, FaPuzzlePiece } from "react-icons/fa6";
...
const CoinDetailsPage = () => {
    ...
    return (
        <div className="coin-details-container">
            <Link to='/'
                style={styles.details_back_link}
            >
                <FaArrowLeftLong 
                    style={styles.details_back_link_icon}
                />
                Back to Dashboard
            </Link>
            ...
            {!loading && !error && (
                <>
                    ...
                    <div className="coin-details-info">
                        ...
                        <h3>Current Price: ${coin.market_data.current_price.usd.toLocaleString(
                            'en-US',
                            {
